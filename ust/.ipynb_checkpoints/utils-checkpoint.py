...
def load_uncertain_dataset_split(name, dataset_folder, split="TRAIN"):
    ...
    ts_X = format_dataset(ts, ts_err)
    return ts_X, ts_y
    
def load_uncertain_dataset(name, dataset_folder):
    train_X, train_y = load_uncertain_dataset_split(name, split='TRAIN', dataset_folder=dataset_folder)
    test_X, test_y = load_uncertain_dataset_split(name, split='TEST', dataset_folder=dataset_folder)
